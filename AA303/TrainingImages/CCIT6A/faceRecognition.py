...
def faceDetection(test_img):
    ...
    face_haar_cascade = cv2.CascadeClassifier('/STUDY/Machine Learning/ProjekKehususan/HaarCascade/haarcascade_frontalface_default.xml')
    faces = face_haar_cascade.detectMultiScale(gray_img,scaleFactor=1.3,minNeighbors=3)

    ...
    <div class="jumbotron">
        ...
        <asp:GridView runat="server" ID="GridView1" AutoGenerateColumns="false">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="url_foto" HeaderText="Bukti Kehadiran" Visible="false"></asp:BoundField>
             ...
             ImageUrl='<%# ResolveUrl(Eval("url_foto").ToString()) %>' />
                    ...
                    <asp:BoundField DataField="total_time" HeaderText="Total"></asp:BoundField>
                </Columns>

            </asp:GridView>
        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Start" Visible="false"/>
    </div>
